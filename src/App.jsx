...
label span{font-size:12px;color:#555;margin-bottom:3px;display:block;}
`;
            ...
            <div style={{overflowX:"auto"}}>
              <table className="settle-table">
                ...
                <tbody>
                  ...
                  <tr><td rowSpan={5} style={{background:"#F3E5F5",color:"#6A1B9A",fontWeight:500}}>300,000원</td><td rowSpan={5} style={{fontSize:10,color:"#888"}}>× 계약이행 일수<br/>÷ 전체 일수</td><td>0T초과~10T미만</td><td style={{color:"#D32F2F",fontWeight:600}}>+100,000원</td></tr>
...
function NoticeGen(){
  ...
  const selSt={padding:"8px 10px",borderRadius:8,border:"1px solid #ddd",fontSize:14,marginBottom:0,background:"#fafafa",width:"100%"};
      ...
      {!preview?(
        <div style={{display:"flex",flexDirection:"column",gap:10}}>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
            ...
            <label style={lbSt}><span>수업 형태</span>
              <select value={form.type} onChange={e=>set("type",e.target.value)} style={selSt}>
                <option value="화상">화상 수업</option>
                <option value="방문">방문 수업</option>
              </select>
            </label>
            <label style={lbSt}><span>학교급</span>
              <select value={form.schoolLevel} onChange={e=>set("schoolLevel",e.target.value)} style={selSt}>
            ...
            <label style={lbSt}><span>주 수업 횟수 (타임)</span>
              <select value={form.times} onChange={e=>set("times",e.target.value)} style={selSt}>
            ...
            {/* 플래닝 옵션 */}
            <div style={{display:"flex",alignItems:"center",gap:10,padding:"10px 14px",background:"#F3E5F5",borderRadius:8,border:"1px solid #CE93D8",cursor:"pointer"}} onClick={()=>set("planning",!form.planning)}>
            ...
            {/* 자동계산 수업료 */}
            <div style={{background:"#f0f7ff",borderRadius:10,padding:"12px 16px",border:"1px solid #BBDEFB",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div>
            ...
            <label style={lbSt}><span>학생 비밀번호</span><input value={form.studentPw||""} onChange={e=>set("studentPw",e.target.value)} placeholder="예) 1234"/></label>
        ...
        <div>
          ...
          <div ref={p1} style={{background:"#fff",padding:"40px 36px",fontFamily:"'Malgun Gothic','Apple SD Gothic Neo',sans-serif",maxWidth:700,margin:"0 auto",border:"1px solid #ddd",borderRadius:8}}>
            ...
            <div style={{border:"1.5px solid #4A90D9",borderRadius:10,padding:"20px 24px",marginBottom:20}}>
              <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:16}}><span style={{fontSize:18}}>📅</span><h2 style={{fontSize:16,fontWeight:700,color:"#1a1a1a"}}>수업 일정 및 수업료</h2></div>
            ...
            {form.book&&<div style={{border:"1.5px solid #4A90D9",borderRadius:10,padding:"20px 24px",marginBottom:20}}>
              <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}><span style={{fontSize:18}}>📖</span><h2 style={{fontSize:16,fontWeight:700,color:"#1a1a1a"}}>수업 교재 안내</h2></div>
              <div style={{display:"flex",alignItems:"center",gap:12,padding:"12px 16px",background:"#f9f9f9",borderRadius:8,border:"1px solid #eee"}}>
                ...
                <div><p style={{fontSize:14,fontWeight:600,color:"#1a1a1a"}}>{form.book}</p>{form.publisher&&<p style={{fontSize:12,color:"#888"}}>{form.publisher}</p>}</div>
              </div>
            </div>}
            <div style={{border:"1.5px solid #4A90D9",borderRadius:10,padding:"20px 24px"}}>
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16}}>
                <div style={{display:"flex",alignItems:"center",gap:8}}><span style={{fontSize:18}}>🛡</span><h2 style={{fontSize:16,fontWeight:700,color:"#1a1a1a"}}>학생 로그인 정보</h2></div>
                <span style={{fontSize:13,fontWeight:700,color:"#D32F2F"}}>로그인 시 [회원]을 선택하여 입장해 주세요</span>
              </div>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12,marginBottom:14}}>
                <div style={{padding:"12px 16px",background:"#f9f9f9",borderRadius:8,textAlign:"center"}}><p style={{fontSize:11,color:"#888",marginBottom:6}}>홈페이지 (상상코칭)</p><p style={{fontSize:14,fontWeight:600,color:"#1a1a1a"}}>www.sscoaching.co.kr</p></div>
                <div style={{padding:"12px 16px",background:"#f9f9f9",borderRadius:8,textAlign:"center"}}><p style={{fontSize:11,color:"#888",marginBottom:6}}>학생 아이디</p><p style={{fontSize:14,fontWeight:600,color:"#1a1a1a"}}>{form.studentId||"(아이디 미입력)"}</p></div>
                <div style={{padding:"12px 16px",background:"#f9f9f9",borderRadius:8,textAlign:"center"}}><p style={{fontSize:11,color:"#888",marginBottom:6}}>학생 비밀번호</p><p style={{fontSize:14,fontWeight:600,color:"#1a1a1a"}}>{form.studentPw||"(비밀번호 미입력)"}</p></div>
              </div>
              <div style={{padding:"12px 16px",background:"#f9f9f9",borderRadius:8,marginBottom:14}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
                  <div style={{border:"1px solid #ddd",borderRadius:8,overflow:"hidden"}}>
                    ...
                    <div style={{padding:"10px",fontSize:10}}>
                      <div style={{border:"1px solid #ddd",borderRadius:6,padding:"8px",marginBottom:6,background:"#fafafa"}}>
                        ...
                        <div style={{display:"flex",gap:6,marginBottom:6,fontSize:9,alignItems:"center"}}>
                          <span style={{background:"#1565C0",color:"#fff",padding:"1px 6px",borderRadius:3,fontSize:8}}>● 회원</span>
                          <span style={{fontSize:8,color:"#888"}}>선생님</span>
                        </div>
                        <div style={{background:"#eee",height:16,borderRadius:3,marginBottom:4}}/>
                        <div style={{background:"#eee",height:16,borderRadius:3,marginBottom:6}}/>
                  ...
                  <div style={{border:"1px solid #ddd",borderRadius:8,overflow:"hidden"}}>
                    <div style={{background:"#1565C0",padding:"6px 10px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                      ...
                      <div style={{background:"#D32F2F",color:"#fff",fontSize:9,padding:"2px 6px",borderRadius:3,fontWeight:700}}>③ 탭 클릭</div>
                    </div>
                    <div style={{padding:"10px",fontSize:9,color:"#555",lineHeight:1.6}}>
                      ...
                      <p style={{marginBottom:2,fontWeight:600,fontSize:9}}>④ 아이디 입력</p>
                      <div style={{border:"1px solid #ddd",borderRadius:3,padding:"3px 6px",marginBottom:6,color:"#aaa",fontSize:8}}>아이디 또는 이메일</div>
                      <p style={{marginBottom:2,fontWeight:600,fontSize:9}}>⑤ 법정대리인 선택</p>
          ...
          <div ref={p3} style={{background:"#fff",padding:"40px 36px",fontFamily:"'Malgun Gothic','Apple SD Gothic Neo',sans-serif",maxWidth:700,margin:"24px auto 0",border:"1px solid #ddd",borderRadius:8}}>
            <div style={{width:"100%",height:8,background:"linear-gradient(90deg,#1565C0,#42A5F5)",borderRadius:"4px 4px 0 0",marginBottom:32}}/>
            <div style={{textAlign:"center",marginBottom:28}}><h1 style={{fontSize:26,fontWeight:700,color:"#1a1a1a"}}>결제 수단 및 방식 안내</h1></div>
            <div style={{marginBottom:28}}>
              ...
              <div style={{border:"1px solid #ddd",borderRadius:10,overflow:"hidden"}}>
                ...
                <div style={{padding:"16px",display:"flex",flexDirection:"column",gap:10}}>
                  <div style={{display:"flex",alignItems:"center",gap:8}}><div style={{background:"#1565C0",color:"#fff",padding:"6px 14px",borderRadius:6,fontSize:13,fontWeight:600}}>③ 회비 정기결제</div></div>
                  <div style={{background:"#f9f9f9",padding:"10px 14px",borderRadius:6,fontSize:11,color:"#777",border:"1px solid #eee"}}>④ 정기결제 서비스 이용 동의 체크 후 → ⑤ 정기결제 신청 클릭</div>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                <div style={{border:"1px solid #ddd",borderRadius:10,overflow:"hidden"}}>
                  ...
                  <div style={{padding:"14px",fontSize:12,color:"#333",lineHeight:1.8}}>
                    <p>고객님, 안녕하세요.</p><p>동화세상에듀코 수강료 결제 안내드립니다.</p><br/>
                ...
                <div style={{border:"1px solid #ddd",borderRadius:10,overflow:"hidden"}}>
                  ...
                  <div style={{padding:"14px",fontSize:12,color:"#333",lineHeight:1.8}}>
                    ...
                    <p>고객님, 안녕하세요. 동화세상에듀코 수강료 결제 내역 안내드립니다.</p>
...
function ProgressTab(){
  ...
  useEffect(()=>{
    (async()=>{const result={};for(const coach of coaches){const d=await fbGet("checks",coach);result[coach]=d?d.data:{};}setAllChecks(result);})();
  },[]);
  return(
    <div style={{background:"#fff",border:"1px solid #e0e0e0",borderRadius:12,padding:"1rem 1.25rem"}}>
...
.res-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(190px,1fr));gap:10px;}
.check-item{display:flex;align-items:center;gap:10px;padding:8px 10px;border-radius:8px;background:#f9f9f9;border:1px solid #eee;margin-bottom:7px;}
input,textarea,select{width:100%;padding:8px 10px;border-radius:8px;border:1px solid #ddd;font-size:14px;margin-bottom:8px;background:#fafafa;}
.settle-table{width:100%;border-collapse:collapse;font-size:12px;}
.settle-table th,.settle-table td{border:1px solid #ddd;padding:6px 8px;text-align:center;vertical-align:middle;}
.settle-table th{background:#f5f5f5;font-weight:600;font-size:11px;}
label span{font-size:12px;color:#555;margin-bottom:3px;display:block;}
